...
# Paths
ROOT = "/content/CosmoBoard"
PAPERS_CSV = os.path.join(ROOT, "datasets", "papers.csv")
LINKS_CSV  = os.path.join(ROOT, "datasets", "paper_to_datasets.csv")
...
paper_to_datasets = (
    links.groupby("paper_pmcid")
         .apply(lambda g: [_group_row(r) for _, r in g.iterrows()])
         .to_dict()
)
